        ...
        <Container>
            <Carousel data-bs-theme="light">
                <Carousel.Item>
                    ...
                    <Carousel.Caption>
                        <h5>Apple Watch</h5>
                        <p>Built-in GPS. Water resistance to 50 meters. A new lightning-fast dual-core processor. And a display that’s two times brighter than before.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    ...
                    <Carousel.Caption>
                        ...
                        <p>A complete 1080p camera and 3-axis gimbal system are integrated with the Phantom 3 Advanced edition quadcopter from DJI.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
